...
var browserView = Backbone.View.extend({
    ...
    OutputView = Backbone.View.extend({
        el: "#designer-view .output-container",
        add: function(a, c, b) {
            switch (a) {
                case "s":
                    c = '<div class="sent bold' + (b ? " failed" : "") + '"><i class="icon-' + (b ? "attention" : "angle-right") + '""></i>' + c + (b ? " <small>(failed to sent)</small>" : "") + "</div>";
...
var cameraView = Backbone.View.extend({
    ...
    OutputView = Backbone.View.extend({
        el: "#camera-view .output-container",
        add: function(a, c, b) {
            switch (a) {
                case "s":
                    c = '<div class="sent bold' + (b ? " failed" : "") + '"><i class="icon-' + (b ? "attention" : "angle-right") + '""></i>' + c + (b ? " <small>(failed to sent)</small>" : "") + "</div>";
...
var AppRouter = Backbone.Router.extend({
	...
	designer: function() {
        this.designerView || (this.designerView = new designerView);
        this.selectView(this.designerView)
    },
	camera: function() {
        this.cameraView || (this.cameraView = new cameraView);
